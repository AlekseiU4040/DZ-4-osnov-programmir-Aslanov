...
System.Console.WriteLine($"A в степени B =: {Exponentiation(numA, numB)}");
...
System.Console.WriteLine($"Сумма цифр в числе = {Summa(mean)}");
...
System.Console.WriteLine("Ввод элементов вручную");
